...
- **A.** #12 额度风控与跨租户合并（工行无事前校验接口，须自建连续 12 个月滚动台账；见 `docs/icbc/工行答复-2026-09-18.md` §四）；
- **B.** #13 代办税费申报（按月清单、申报期预警、10 万元免征线、1% / 3% 分列）；
- **C.** #15 平台运营：通知监控与重放；#16 计费计量；
- **D.** #20 收货员现场端（uni-app H5）、#19 自然人出售者端。
