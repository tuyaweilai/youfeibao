...
- 反向开票：出售者档案 / 出售者建档 / 收购登记 / 付方档案 / 开票申请（按收购单）/ 付款 / 发票下载与证据 / 一票一档 / 额度台账
...
- **A.** #13 代办税费申报（按月清单、申报期预警、10 万元免征线、1% / 3% 分列）；额度台账已提供「出售者 × 月」的净销售额与 1% / 3% 分列，可直接复用；
- **B.** #15 平台运营：通知监控与重放；#16 计费计量；
