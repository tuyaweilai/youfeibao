...
-- 插入系统预定义的合同类型
INSERT INTO `contract_types` (`id`, `type_name`, `type_code`, `type_description`, `is_system_defined`, `is_active`, `sort_order`, `tenant_id`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES
(1, '危险废物转移合同', 'WASTE_TRANSFER', '产废企业与回收企业之间的危险废物转移合同', b'1', b'1', 1, 0, 'system', NOW(), 'system', NOW(), b'0'),
(2, '物流服务合同', 'LOGISTICS_SERVICE', '回收企业与物流企业之间的物流服务合同', b'1', b'1', 2, 0, 'system', NOW(), 'system', NOW(), b'0'),
(3, '废物处置合同', 'WASTE_DISPOSAL', '回收企业与处置企业之间的废物处置合同', b'1', b'1', 3, 0, 'system', NOW(), 'system', NOW(), b'0'),
(4, '平台服务协议', 'PLATFORM_SERVICE', '企业与平台之间的服务协议', b'1', b'1', 4, 0, 'system', NOW(), 'system', NOW(), b'0'),
(5, '采购合同', 'PROCUREMENT', '企业间的采购合同', b'1', b'1', 5, 0, 'system', NOW(), 'system', NOW(), b'0'),
(6, '技术服务合同', 'TECHNICAL_SERVICE', '技术服务相关合同', b'1', b'1', 6, 0, 'system', NOW(), 'system', NOW(), b'0');
