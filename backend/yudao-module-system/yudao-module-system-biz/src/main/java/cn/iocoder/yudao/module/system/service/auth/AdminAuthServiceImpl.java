...
public class AdminAuthServiceImpl implements AdminAuthService {
    ...
    public AuthLoginRespVO smsLogin(AuthSmsLoginReqVO reqVO) {
        ...
        // 创建 Token 令牌，记录登录日志
        return createTokenAfterLoginSuccess(user, LoginLogTypeEnum.LOGIN_MOBILE);
    }
    ...
    public AuthLoginRespVO socialLogin(AuthSocialLoginReqVO reqVO) {
        ...
        // 创建 Token 令牌，记录登录日志
        return createTokenAfterLoginSuccess(user, LoginLogTypeEnum.LOGIN_SOCIAL);
    }
    ...
    private AuthLoginRespVO createTokenAfterLoginSuccess(AdminUserDO user, LoginLogTypeEnum logType) {
        // 插入登录日志
    ...
    public AuthLoginRespVO register(AuthRegisterReqVO registerReqVO) {
        ...
        // 2. 校验用户名是否已存在
        AdminUserDO user = userService.registerUserAndGet(registerReqVO);
