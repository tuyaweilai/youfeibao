...
public enum RecyclingRoleEnum {
    ...
    ADMIN("tenant_admin", "管理员", Set.of(
            ...
            RecyclingPermission.STOCK_OUT_QUERY, RecyclingPermission.STOCK_OUT_MANAGE,
            RecyclingPermission.STOCK_MOVE_QUERY, RecyclingPermission.STOCK_MOVE_MANAGE,
            RecyclingPermission.STOCK_CHECK_QUERY, RecyclingPermission.STOCK_CHECK_MANAGE,
            RecyclingPermission.STOCK_OPENING_QUERY, RecyclingPermission.STOCK_OPENING_MANAGE,
