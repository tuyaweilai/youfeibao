 ...
 * 自然人汇算清缴对账单响应（公开端点）。
 *
 * <p>出售者须在次年 3 月 31 日前自行汇算清缴。他凭收购确认书 / 提醒里的免登录令牌就能看
 * 「当年开了多少票、已预缴多少税」，不必登门、不必注册——这是回收企业提供开票与已缴税款
 * 信息义务的落地形式。
 */
@Schema(description = "公开端点 - 自然人汇算清缴对账单 Response VO")
@Data
public class PublicSettlementStatementRespVO {
     ...
     * 对账单里的一个月。
     */
    @Schema(description = "公开端点 - 汇算清缴对账单月度明细")
    @Data
