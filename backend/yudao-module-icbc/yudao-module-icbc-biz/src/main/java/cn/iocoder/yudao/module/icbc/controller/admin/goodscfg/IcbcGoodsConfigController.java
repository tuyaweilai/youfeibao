...
public class IcbcGoodsConfigController {
    ...
    @PreAuthorize("@icbc.hasPermission('icbc:goods-config:create')")
    ...
    @PreAuthorize("@icbc.hasPermission('icbc:goods-config:update')")
    ...
    @PreAuthorize("@icbc.hasPermission('icbc:goods-config:delete')")
    ...
    @Parameter(name = "id", description = "编号", required = true)
    @PreAuthorize("@icbc.hasPermission('icbc:goods-config:query')")
