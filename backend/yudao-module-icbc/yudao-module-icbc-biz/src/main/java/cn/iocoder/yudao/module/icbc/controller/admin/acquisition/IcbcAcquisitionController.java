...
public class IcbcAcquisitionController {
    ...
    @PreAuthorize("@icbc.hasPermission('" + RecyclingPermission.ACQUISITION_UPDATE + "')")
    ...
    @PreAuthorize("@icbc.hasPermission('" + RecyclingPermission.ACQUISITION_QUERY + "')")
    ...
    @Parameter(name = "id", description = "收购单编号", required = true, example = "1024")
    @PreAuthorize("@icbc.hasPermission('" + RecyclingPermission.ACQUISITION_EXPORT + "')")
