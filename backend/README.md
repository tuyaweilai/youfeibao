...
cd /home/devbox/project/ruoyi-vue-pro && mvn -pl yudao-server exec:java -Dexec.mainClass="cn.iocoder.yudao.server.YudaoServerApplication" -Dexec.classpathScope="runtime" -Dfile.encoding=UTF-8


mvn clean package -DskipTests -pl yudao-module-enterprise/yudao-module-enterprise-biz -am