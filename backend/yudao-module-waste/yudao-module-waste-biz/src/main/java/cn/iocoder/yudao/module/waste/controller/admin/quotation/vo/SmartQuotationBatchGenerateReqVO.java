...
@Schema(description = "管理后台 - 批量智能报价生成 Request VO")
@Data
public class SmartQuotationBatchGenerateReqVO {

    @Schema(description = "预约单ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotNull(message = "预约单ID不能为空")
    private Long appointmentId;

    @Schema(description = "回收企业ID列表", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotEmpty(message = "回收企业ID列表不能为空")
